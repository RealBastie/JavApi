...
class XMLParser {
     ...
     */
    static const String PREFS_DTD_NAME = "http://java.sun.com/dtd/preferences.dtd"; //$NON-NLS-1$

    /*
     * Constant - the DTD string
     */
    static const String PREFS_DTD = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
     ...
     */
    static const String HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"; //$NON-NLS-1$

    /*
     * Constant - the specified DOCTYPE
     */
    static const String DOCTYPE = "<!DOCTYPE preferences SYSTEM"; //$NON-NLS-1$
